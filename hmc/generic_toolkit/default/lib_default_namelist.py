namelist_variable_default = {
    ...
    'iDtModel': 'dt_run',
    'iDtData_Forcing': 'dt_data_forcing',
    'iDtData_Output_Gridded': 'dt_data_output_gridded',
    'iDtData_Output_Point': 'dt_data_output_point',
    'sTimeStart': 'time_start',
    'sTimeRestart': 'time_restart',
    'sPathData_Static_Gridded': 'path_data_static_gridded',
    'sPathData_Static_Point': 'path_data_static_point',
    'sPathData_Forcing_Gridded': 'path_data_forcing_gridded',
    'sPathData_Forcing_Point': 'path_data_forcing_point',
    'sPathData_Forcing_TimeSeries': 'path_data_forcing_timeseries',
    'sPathData_Output_Gridded': 'path_data_output_gridded',
    'sPathData_Output_Point': 'path_data_output_point',
    'sPathData_Output_TimeSeries': 'path_data_output_timeseries',
}
