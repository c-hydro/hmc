...
class VolumeHandler(GeoHandler):
    ...
    def __init__(self, da_s: xr.DataArray, da_terrain: xr.DataArray, da_reference: xr.DataArray, parameters: dict) -> None:
    ...
    def organize_data(self, dset_data: xr.Dataset = None, **kwargs) -> xr.Dataset:
        ...
        var_vtot = compute_volume_total(s=var_s,
                                        terrain=var_terrain, cpi=self.parameters['cpi'])
